...
#define FEC_SENS_CHANNEL_CONFIG_DEF(NAME,                              \
                                     ...
                                     DEVICE_NUMBER,                     \
                                     NETWORK_NUMBER)                    \
static const ant_channel_config_t   CONCAT_2(NAME, _channel_fec_sens_config) =   \
    {                                                                   \
        .channel_number    = (CHANNEL_NUMBER),                          \
...
#define FEC_SENS_CHANNEL_CONFIG(NAME) &CONCAT_2(NAME, _channel_fec_sens_config)
...
#define FEC_SENS_PROFILE_CONFIG_DEF(NAME,                              \
                                     EVT_HANDLER)                       \
static ant_fec_cb_t            CONCAT_2(NAME, _fec_sens_cb);               \
static const ant_fec_config_t  CONCAT_2(NAME, _profile_fec_sens_config) =  \
    {                                                                   \
        .p_cb               = &CONCAT_2(NAME, _fec_sens_cb),                     \
        .evt_handler        = (EVT_HANDLER),                            \
    }
#define FEC_SENS_PROFILE_CONFIG(NAME) &CONCAT_2(NAME, _profile_fec_sens_config)

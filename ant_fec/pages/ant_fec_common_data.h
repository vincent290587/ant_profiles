...
#ifndef ANT_FEC_COMMON_DATA_H__
#define ANT_FEC_COMMON_DATA_H__

/** @file
 *
 * @defgroup ant_sdk_profiles_fec_common_data_page Stride Based Speed and Distance Monitor profile common data
 * @{
...
/**@brief Data structure for FEC common data.
 *
...
} ant_fec_common_data_t;

/**@brief Initialize common data.
 */
#define DEFAULT_ANT_FEC_COMMON_DATA()  \
    (ant_fec_common_data_t)            \
    {                                   \
